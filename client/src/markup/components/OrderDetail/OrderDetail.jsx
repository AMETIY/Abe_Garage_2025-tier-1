          ...
          <div className="auto-container text-center py-5">
            <div className="sec-title style-two">
              ...
              <p className="text-muted">
                We couldn’t locate the order you're looking for. It might have
          ...
          <div className="auto-container">
            <div class="sec-title style-two">
              <div class="d-flex justify-content-between align-items-center">
                <h2>
                  {singleOrder?.customer_first_name}{" "}
                  {singleOrder?.customer_last_name}
                </h2>
                <div
              ...
              <div className="col-lg-6 service-block-one">
                <div className="inner-box hvr-float-shadow">
                  ...
                  <p>
                    Active customer:{" "}
                    <span className="text-muted small">
                      {singleOrder?.active_customer_status}{" "}
                    </span>
                  </p>
              ...
              <div className="col-lg-6 service-block-one">
                <div className="inner-box hvr-float-shadow">
                  ...
                  <p>
                    vehicle year:{" "}
                    <span className="text-muted small">
                      {singleOrder?.vehicle_year}
                    </span>{" "}
                  </p>
                  <p>
                    vehicle mileage:{" "}
                    <span className="text-muted small">
                      {singleOrder?.vehicle_mileage}
                    </span>{" "}
                  </p>
